...
#SURF AM
event_1 = Event.create!(user_id: user_1.id, title: "Surf with #{user_1.user_name}", description: "Let's go surfing together", address: "Canggu", sport: "Surfing", date: Date.today, time_of_event: "8:00", number_of_participants: 4, morning: true)
...
#TENNIS AM
event_2 = Event.create!(user_id: user_5.id, title: "Tennis with #{user_5.user_name}", description: "Let's go and play tennis together", address: "Canggu", sport: "Tennis", date: Date.today, time_of_event: "10:00", number_of_participants: 2, morning: true)
...
#TENNIS EVENING
event_9 = Event.create!(user_id: user_8.id, title: "Tennis with #{user_8.user_name}", description: "Let's go and play tennis together", address: "Canggu", sport: "Tennis", date: Date.yesterday, time_of_event: "20:00", number_of_participants: 2, evening: true)
